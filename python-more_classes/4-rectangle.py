...
class Rectangle:
    """A class that defines a rectangle with eval-compatible representation."""
    ...
    def __str__(self):
        """Return string representation using hash characters.
    ...
    def __repr__(self):
        ...
        Returns:
            str: A string that recreates the instance when passed to eval.
        """
